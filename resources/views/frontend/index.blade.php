    ...
    <div class="collections container pt-5">
        <div class="row">
            <div class="women col-6">
                <div class="card mb-3">
                    <img src="{{ asset('img/layer.png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-6">
                <div class="right-boxes row g-0">
                    <div class=" text-center mb-2 col-12 position-relative">
                        <img class="img-fluid" src="{{ asset('img/layer1.png') }}" alt="">
                    ...
                    <div class=" text-center mt-3 col-12 position-relative">
                        <img class="img-fluid" src="{{ asset('img/layer2.png') }}" alt="">
                        <div class="descripe text-center position-absolute top-0 start-0">
        ...
        <div class="row g-0 ads">
            <div class="col-lg-6 col-md-12  position-relative">
                <img src="{{ asset('img/layer3.png') }}" alt="">
            ...
            <div class="col-lg-6 col-md-12  position-relative">
                <img src="{{ asset('img/layer4.png') }}" alt="">
